...
async def ask_ticker_for_create_subscription(message: Message, state: FSMContext):
...
async def ask_ticker_for_delete_subscription(message: Message, state: FSMContext):
    await message.answer("Введите тикер, например: <b>SBER</b>", parse_mode="HTML")
